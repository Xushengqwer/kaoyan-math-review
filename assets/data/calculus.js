registerSubject({
  ...
  chapters: [
    ...
    { id: "derivative", name: "一元函数微分学", order: 2, modules: [
      ...
      { no: "三", name: "中值定理、泰勒公式与洛必达法则", brief: "中值定理把函数值与导数联系起来，泰勒公式、洛必达法则都由它推出" },
      { no: "四", name: "导数的应用", brief: "用导数研究函数的性态与曲线的几何性质" }
    ] },
    // 第3章按「模块」组织：4 个模块 8 张卡。
    { id: "integral", name: "一元函数积分学", order: 3, modules: [
      { no: "一", name: "不定积分", brief: "求导的逆运算：原函数、基本公式与三大积分法" },
      { no: "二", name: "定积分", brief: "和式的极限：概念与性质、微积分基本定理与计算方法" },
      { no: "三", name: "反常积分", brief: "积分区间无穷或被积函数无界时的推广" },
      { no: "四", name: "定积分的应用", brief: "微元法求几何量与物理量" }
    ] },
    // 第4章按「模块」组织：3 个模块 7 张卡。
    { id: "vector-geometry", name: "向量代数与空间解析几何", order: 4, modules: [
      { no: "一", name: "向量及其运算", brief: "工具：向量的坐标与三种乘积" },
      { no: "二", name: "平面与直线", brief: "用法向量写平面、方向向量写直线，位置关系、夹角与距离都化为向量运算" },
      { no: "三", name: "曲面与空间曲线", brief: "柱面、旋转曲面、二次曲面，以及曲线的投影" }
    ] },
    // 第5章按「模块」组织：4 个模块 7 张卡。
    { id: "multivar-derivative", name: "多元函数微分学", order: 5, modules: [
      { no: "一", name: "多元函数的基本概念", brief: "极限与连续、偏导数与全微分，以及这几个概念之间的关系" },
      { no: "二", name: "多元函数求导法则", brief: "复合函数与隐函数的偏导数怎么求" },
      { no: "三", name: "方向导数、梯度与几何应用", brief: "任意方向的变化率，以及曲线、曲面的切线与法线" },
      { no: "四", name: "多元函数的极值", brief: "无条件极值、最值与条件极值" }
    ] },
    // 第6章按「模块」组织：4 个模块 7 张卡。
    { id: "multiple-integral", name: "重积分（二重积分、三重积分）", order: 6, modules: [
      { no: "一", name: "二重积分", brief: "定义与性质，以及直角坐标、极坐标下的计算" },
      { no: "二", name: "三重积分", brief: "投影法、截面法、柱面坐标与球面坐标" },
      { no: "三", name: "对称性", brief: "利用区域与被积函数的对称性化简重积分" },
      { no: "四", name: "重积分的应用", brief: "体积、曲面面积、质量、质心与转动惯量" }
    ] },
    // 第7章按「模块」组织：3 个模块 8 张卡。
    { id: "line-surface-integral", name: "曲线积分与曲面积分", order: 7, modules: [
      { no: "一", name: "曲线积分与格林公式", brief: "两类曲线积分，平面上的格林公式与路径无关" },
      { no: "二", name: "曲面积分与高斯、斯托克斯公式", brief: "两类曲面积分，以及把它们与三重积分、曲线积分联系起来的两个公式" },
      { no: "三", name: "对称性与物理应用", brief: "对称性化简，以及曲线、曲面构件的质量、质心与转动惯量" }
    ] },
    // 第8章按「模块」组织：3 个模块 7 张卡。
    { id: "series", name: "无穷级数", order: 8, modules: [
      { no: "一", name: "常数项级数", brief: "收敛的定义与性质，正项级数与任意项级数的判别法" },
      { no: "二", name: "幂级数", brief: "收敛域、和函数，以及把函数展开成幂级数" },
      { no: "三", name: "傅里叶级数", brief: "把周期函数展开成三角级数" }
    ] },
    // 第9章按「模块」组织：3 个模块 8 张卡。
    { id: "ode", name: "常微分方程", order: 9, modules: [
      { no: "一", name: "基本概念", brief: "微分方程、阶、解、通解与特解" },
      { no: "二", name: "一阶微分方程", brief: "按方程类型选解法：分离变量、换元、公式与全微分" },
      { no: "三", name: "高阶微分方程", brief: "可降阶的方程，线性方程解的结构，常系数方程与欧拉方程" }
    ] }
  ],
  items: [
    {
      ...
      tags: ["函数", "定义域", "有界性", "单调性", "奇偶性", "周期性", "复合函数", "反函数", "基本初等函数", "初等函数", "分段函数", "定义", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["导数", "左导数", "右导数", "可导", "切线", "法线", "可导与连续", "微分", "可微", "微分形式不变性", "线性主部", "定义", "定理", "性质"]
    },
    {
      id: "calc-der-rules",
      chapterId: "derivative",
      ...
      tags: ["基本初等函数的导数", "求导公式", "四则运算法则", "链式法则", "复合函数求导", "反函数求导", "隐函数求导", "对数求导法", "参数方程求导", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["凹凸性", "拐点", "渐近线", "水平渐近线", "铅直渐近线", "斜渐近线", "弧微分", "曲率", "曲率半径", "曲率圆", "定义", "定理", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["定积分", "黎曼和", "可积", "几何意义", "和式极限", "线性性", "区间可加性", "保号性", "估值定理", "积分中值定理", "平均值", "定义", "定理", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["微元法", "平面图形面积", "旋转体体积", "平行截面", "弧长", "旋转曲面面积", "变力做功", "液体压力", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["两平面夹角", "两直线夹角", "直线与平面夹角", "平行", "垂直", "共面", "异面", "点到平面的距离", "点到直线的距离", "平行平面间距离", "异面直线的距离", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["偏导数", "高阶偏导数", "混合偏导数", "求导次序", "全微分", "可微", "必要条件", "充分条件", "连续", "偏导数存在", "定义", "定理", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["极值", "驻点", "必要条件", "充分条件", "二阶泰勒公式", "最值", "条件极值", "拉格朗日乘数法", "拉格朗日函数", "约束条件", "定义", "定理", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["体积", "曲顶柱体", "曲面面积", "曲面面积元", "质量", "质心", "形心", "转动惯量", "密度", "定义", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["高斯公式", "通量", "散度", "补面法", "斯托克斯公式", "环流量", "旋度", "右手法则", "定义", "定理", "性质"]
    },
    {
    ...
    },
    {
      ...
      tags: ["三角函数系", "正交性", "傅里叶系数", "傅里叶级数", "狄利克雷收敛定理", "正弦级数", "余弦级数", "奇延拓", "偶延拓", "周期为2l的傅里叶级数", "定义", "定理", "性质"]
    },
    {
    ...
    {
      id: "calc-ode-constant-coefficient",
      chapterId: "ode",
      type: "property",
      types: ["property"],
      module: 3,
